 ...
 <StackLayout backgroundColor="white">
  <StackLayout orientation="horizontal" >
   ...
   <StackLayout marginLeft="24" marginTop="15">
    <TextView width="217" v-if="isAndroid"  style="font-family: nanumsquareroundr"  fontSize="13" maxLength="50" color="#aaaaaa" v-model="data.keyword" @textChange="changeWrap" borderColor="white" hint="검색어를 입력해주세요." editable="true" backgroundColor="white"></TextView>
   </StackLayout>
