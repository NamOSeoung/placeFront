            ...
            return {
                items: [
                    ...
                    },
                    {
                        ...
                        children: [ {
                            text: 'Me',
                            image: '~/assets/images/shazam.jpg'
                    ...
                    },
                    {
                        ...
                        children: [ { text: 'This', image: '~/assets/images/a9ff17db85f8136619feb0d5a200c0e4.png' }, {
                            text: 'Thing',
                            image: '~/assets/images/shazam.jpg'
                        } ]
                    },
                    {
                        ...
                        children: [ { text: 'Now', image: '~/assets/images/batman.png' }, {
                            text: 'Please',
