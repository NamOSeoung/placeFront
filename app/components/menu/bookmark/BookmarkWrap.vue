<template lang="html">
 <GridLayout rows="auto,auto,*,auto" columns="auto">
  ...
  <GridLayout v-show="selectedTabview == 0" row="2" width="100%" paddingTop="" height="100%" backgroundColor="#eff2f7" >
   <PlaceBookmark/>
 <!--  <ListView ref="listview" separatorColor="transparent" for="item in items" :key="index">
  ...
  <GridLayout v-show="selectedTabview == 1" row="2" width="100%"  paddingTop="" height="100%" backgroundColor="#eff2f7">
   <YoutubeBookmark />
  </GridLayout>

  <GridLayout v-show="selectedTabview == 2" row="2" width="100%"  paddingTop="" height="100%" backgroundColor="#eff2f7">
   <NaverBookmark />
 </GridLayout>

  <GridLayout v-show="selectedTabview == 3" row="2" width="100%" paddingTop="" height="100%" backgroundColor="#eff2f7">
    <TistoryBookmark />
